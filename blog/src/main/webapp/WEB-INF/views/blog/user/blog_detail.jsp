						...
						<div class="col-lg-9 col-md-12 col-12">
							<div class="article-rte">
								...
								<div class="article-meta">
									<h2 class="article-title">Delivering What Consumers Really
										Value?</h2>
									<div
										...
										<span class="article-author d-flex align-items-center">
											<span class="icon-author"><svg width="15" height="17"
												...
												Joe</span>
										</span> <span class="article-separator mx-3"> <svg width="2"
												height="12" viewBox="0 0 2 12" fill="none"
												xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.4"
													d="M1.09761 0.5H0V11.5H1.09761V0.5Z" fill="black" />
                                            </svg>
										</span> <a href="#" class="article-date d-flex align-items-center">
										...
										</span> <span class="ms-2">3 Comments</span>
										</a> <span class="article-separator mx-3 d-none d-sm-block">
											<svg width="2" height="12" viewBox="0 0 2 12" fill="none"
												xmlns="http://www.w3.org/2000/svg">
                                            <path opacity="0.4"
													d="M1.09761 0.5H0V11.5H1.09761V0.5Z" fill="black" />
                                            </svg>
										</span> <a href="article.html"
											class="article-date d-none d-sm-flex align-items-center">
											<span class="icon-tag"> <svg width="22" height="18"
										...
										</span> <span class="ms-2">Furniture</span>
										</a>
									</div>
								</div>
								...
								<div class="article-content">
									<p>These cases are perfectly simple and easy to
										distinguish. In a free hour, when our power of choice hand,
										organizations have the need for integrating in IT departments
										new technologies.</p>

									<p>A wonderful serenity has taken possssion of my entire
										souing like these sweet mornng spring with my whole heart I am
										alone, and feel the charm of existenceths spot whch was create
										of souls like mineing am so happy my dear frend so absori bed
										in the exquste sens of mere.</p>

									<p>A wonderful serenity has taken posseson of my entire
										soung like these sweet mornngs spring enjoy with my whole
										heart I am alone and feel the charm of exstenceths spot whch
										was created ouls like mineing am so happy my dear frend so
										absoribed in the exquste sense of mere tranquil that neglect
										my talentsr I should bye ncapable of drawng and single stroke
										at the A wonderful se taken possesson of my entre souing like.</p>



									<h6 class="heading_24 mb-3 mt-5">A Perfect product for you</h6>
									<p>It is a long established fact that a reader will be
										distracted by the readable content of a page looking at its
										layout.The point of using Lorem Ipsum is that it has a
										more-or-less normal distribu letters, as opposed to using
										‘Content here, content here’, making it look like readable
										English. Many desktop publishing packages and web page editors
										now use Lorem Ipsum as their.</p>
								</div>


								<div class="share-area mt-5 d-flex align-items-center">
									<strong class="label mb-1 d-block">Like</strong> <input
										type="checkbox" class="checkbox" id="checkbox" /> <label
										for="checkbox"> <svg id="heart-svg"
								...
								<div class="share-area mt-5 d-flex align-items-center">
									...
									<ul
										...
										<li class="share-item"><svg width="9" height="16"
								...
								<div
									class="next-prev-article mt-5 d-flex align-items-center justify-content-between">
									<a href="article.html"
										class="article-btn prev-article-btn mt-2">PREV ARTICLE</a> <a
										href="article.html"
										class="article-btn next-article-btn active mt-2">NEXT
										ARTICLE</a>
								</div>


								<div
									class="comments-section mt-100 home-section overflow-hidden">
									...
									<div class="comments-area">
											...
											<div class="comments-main">
												<div class="comments-main-content">
													<div class="comments-meta">
														<a href="blog_main.html" class="commentator-name"> Shakespeare D. Willaim</a>
														<div
															class="comments-date article-date d-flex align-items-center">
														...
														<p class="comments">The second Bag is a corner room
															with double windows. The Bag has fabulous spa new
															appliances, and a laundry area. Other features include
															rich herringbone floors.</p>
													</div>
													<button type="button" class="btn-like">
														<!-- 좋아요 아이콘을 나타내는 SVG 코드를 추가하세요 -->
														<svg style="color: red" xmlns="http://www.w3.org/2000/svg"
															width="16" height="16" fill="currentColor"
															class="bi bi-heart" viewBox="0 0 16 16"> <path
													...
													<button type="button"
														...
														<span class="btn-reply-icon me-2"> <svg width="16"
														...
														</span> <span class="btn-reply-text">Reply</span>
													</button>
												</div>
												<div class="comments-replied">
													<div class="d-flex comments-item">
														...
														<div class="comments-main">
															<div class="comments-meta">
																<a href="blog_main.html" class="commentator-name">Marvin McKinney</a>
																<div
																	class="comments-date article-date d-flex align-items-center">
																	<span class="icon-publish"> <svg width="17"
																			height="18" viewBox="0 0 17 18" fill="none"
															...
															<button type="button"
																class="btn-reply bg-transparent d-flex align-items-center">
																<span class="btn-reply-icon me-2"> <svg
										...
										<div class="d-flex comments-item">
											...
											<div class="comments-main">
												<div class="comments-main-content">
													<div class="comments-meta">
														<a href="blog_main.html" class="commentator-name">Albert Flores</a>
														<div
															class="comments-date article-date d-flex align-items-center">
															<span class="icon-publish"> <svg width="17"
																	height="18" viewBox="0 0 17 18" fill="none"
									...
									<div class="comment-form-area">
										<div class="form-header">
											<h4 class="form-title">댓글쓰기</h4>
										</div>
										<form action="#" class="comment-form">

											<div class="field-item textarea-field">
												<span class="field-icon"> <svg width="20" height="19"
											...
											<!-- <div class="form-checkbox d-flex align-items-center mt-4">
												<input class="form-check-input mt-0" type="checkbox" /> <label
													class="form-check-label ms-2"> Save my information
													in this browser for the next time. </label>
											</div> -->
											<button type="submit"
												class="position-relative review-submit-btn mt-4">SUBMIT</button>
										</form>
									</div>
								</div>
						...
						<div class="col-lg-3 col-md-12 col-12">
							<div class="filter-drawer blog-sidebar">
								<div class="filter-widget widget-blogger text-center">
									...
									<a href="blog_main.html" class="blogger-name heading_18 mb-1">Shakespeare D. Willaim</a>
