...
<head>
 ...
 // 아이디 유효성 체크
    $("#userid").blur(function(){
        	var blog_id = $("#userid").val();
        	if(blog_id == "" || blog_id.length < 5 || blog_id.length > 15){
        		$(".successIdChk").text("영소문자 5자 이상 15자 이하로 입력해주세요:)");
    			$(".successIdChk").css("color", "red");
    			$("#idDoubleChk").val("false");
        	}else{
        		$.ajax({
    				url : '${pageContext.request.contextPath}/idCheck?blog_id='+ blog_id,
    				type : 'post',
    				cache : false,
                        ...
                        <div class="row">
                            <div class="col-12">
                                <fieldset>
					                ...
					                <div class="input-group">
					                    <input id="userid" type="text" name="blog_id" class="form-control" required autofocus/>
					                	<label class="labelcheck">중복 확인</label>
                            ...
                            <div class="col-12">
                                <fieldset>
                                    ...
                                    <input type="password" />
                                    <label class="labelcheck">불일치</label>
                                </fieldset>
                            </div>
                            <div class="col-12">
                                <fieldset>
                                    ...
                                    <label class="labelcheck">사용 가능</label>
                                </fieldset>
                            </div>
                            <div class="col-12">
                                <fieldset>
					                ...
					                <div class="input-group">
					                    ...
					                    <div class="input-group-append">
					                        <button class="btn duplicatecheck" type="button">인증번호 보내기</button>
					                    </div>
					                </div>
                                </fieldset>
                            </div>
                            <div class="col-12">
                                <fieldset>
                                    <label class="label">이메일 인증번호</label>
					                <div class="input-group">
					                    <input type="email"  class="form-control" />
					                    <div class="input-group-append">
					                        <button class="btn duplicatecheck" type="button">이메일 인증</button>
					                    </div>
					                    <label class="labelcheck">인증번호가 일치합니다</label>
					                </div>
                                </fieldset>
                            </div>
